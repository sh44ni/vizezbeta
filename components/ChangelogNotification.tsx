...
import { X, Sparkles, Brain, ShieldCheck, Zap } from 'lucide-react';
...
const CHANGES: ChangeItem[] = [
  {
    ...
    title: 'Production-Grade Passport AI',
    description:
      'Upgraded to GPT-4o Passport Expert with country-specific knowledge for 15+ nationalities. The AI now reasons about digit counts, validity periods, MRZ cross-verification, and date logic before returning any data.',
    tag: 'Major',
    tagColor: '#7c5cfc',
  },
  {
    icon: <ShieldCheck className="w-4 h-4" />,
    title: 'Server-Side Validation Engine',
    description:
      'Every extraction now runs through automatic post-processing checks: date format validation, passport number digit counts, country-specific validity period verification, and age reasonableness checks. Warnings are shown inline during review.',
    tag: 'New',
    tagColor: '#10b981',
  },
  {
    icon: <Zap className="w-4 h-4" />,
    title: 'Gender & Expiry Date Bug Fixes',
    description:
      'Fixed the autofiller always selecting "Male" regardless of passport data (caused by fuzzy string matching). Fixed expiry dates being hallucinated instead of read from the document.',
    tag: 'Fix',
    tagColor: '#f59e0b',
  },
  {
    ...
    description:
      'Choose your extraction model in Manual Visa. GPT-4 Passport Expert is live now — Claude Sonnet 4 Passport Expert coming soon.',
    tag: 'New',
    tagColor: '#10b981',
  },
];
