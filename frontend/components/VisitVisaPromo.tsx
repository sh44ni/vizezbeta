    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Sparkles style={{ width: 14, height: 14, color: '#9b85ff' }} />
          <span style={{
        ...
        <div style={{
          ...
          {[
            ...
            { icon: Clock, label: '95% faster', color: 'rgba(255,255,255,0.60)' },
            { icon: Shield, label: '99% accuracy', color: '#4ade80' },
          ].map((stat, i) => (
            <div key={i} style={{
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  background: isHovered ? step.color : '#111111',
                  border: `1px solid ${isHovered ? step.color : 'rgba(255,255,255,0.08)'}`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: '16px',
                  transition: 'all 0.25s ease',
